...
Afterfeed automatically recognizes supported Twitter/X, Mastodon, Facebook, Reddit, Instagram, and LiveJournal export formats. Browser uploads are attached to the signed-in user. For a command-line import:
